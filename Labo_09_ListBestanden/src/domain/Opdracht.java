...
public class Opdracht {
	...
	public boolean equals(Object o) {
		//opdrachten zijn gelijk als alle instantievariabelen gelijk zijn
		boolean gelijk = false;
		if(o instanceof Opdracht){
			Opdracht opdracht = (Opdracht)o;
			if(
				opdracht.getAntwoord().equals(antwoord) &&
				opdracht.getAntwoordHint().equals(antwoordHint) &&
				opdracht.getAuteur().equals(auteur) &&
				opdracht.getCategorie().equals(categorie) &&
				opdracht.getClass().equals(vraag) &&
				opdracht.getOpdrachtID() == opdrachtID &&
				opdracht.getVraag().equals(vraag)
			){
				gelijk = true;
			}
		}
